...
day_today = int(input("Enter today's number (0 for Monday, 1 for Tuesday, ect...):  "))
days_trip = int(input("Enter the duration of your trip in days: "))
day_return = (day_today + days_trip) % 7
print(f"If you leave for your trip on day {day_today} ({week[day_today]}), and your trip lasts {days_trip} days. You will be back on day {day_return} ({week[day_return]}).")
